...
| Build toolchain image | `mise run build:toolchain-image` | Build the verilator-toolchain OCI image |
| E2E test (verilator) | `mise run test:e2e:verilator` | Realistic E2E test with verilator-example/for-shim (builds toolchain image first) |
