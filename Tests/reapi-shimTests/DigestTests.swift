...
struct DigestTests {
    @Test
    func `SHA-256 of empty data matches RFC test vector`() {
    ...
    @Test
    func `digest sizeBytes matches data length`() {
    ...
    @Test
    func `different data produces different digests`() {
